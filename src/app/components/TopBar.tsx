    ...
    <div className="bg-violet-700 text-white py-2 text-sm">
      <div className="w-full max-w-[1200px] mx-auto flex items-center justify-between px-4 whitespace-nowrap">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <FaEnvelope />
            <span>Faizanmedico@gmail.com</span>
          </a>
          {/* Phone */}
          <a
            href="tel:+1234567890"
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ...
            aria-haspopup="true"
            aria-expanded={languageDropdown ? "true" : "false"}
          >
            <span>English</span>
          ...
          <div
            ...
            aria-haspopup="true"
            aria-expanded={currencyDropdown ? "true" : "false"}
          >
            <span>USD</span>
            <span className="text-xs">▼</span>
            {currencyDropdown && (
          ...
          <li className="flex items-center gap-2 hover:text-gray-200">
            <Link href="/account" aria-label="Login page">
              <FaUser />
            </Link>
          </li>
        </div>
